...
namespace WeatherApp.Controllers
{
    public class AdminUsersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "UserId,Email,Password,PasswordSalt,Admin,AdminId")] SystemUser systemUser)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "UserId,Email,Password,PasswordSalt,Admin,AdminId")] SystemUser systemUser)
        {
            if (ModelState.IsValid)
            {
